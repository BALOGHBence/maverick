...
class TestWhaleBot(unittest.TestCase):
    ...
    def test_whale_prefers_raise(self):
        ...
        whale = WhaleBot(id="whale1", name="Whale", state=PlayerState(stack=1000, seat=0))
        ...
        action = whale.decide_action(game, [ActionType.RAISE, ActionType.CALL], min_raise=20)
    ...
    def test_whale_calls_everything(self):
        ...
        whale = WhaleBot(id="whale1", name="Whale", state=PlayerState(stack=100, seat=0))
...
class TestSharkBot(unittest.TestCase):
    ...
    def test_shark_instantiation(self):
        ...
        shark = SharkBot(id="shark1", name="Shark", state=PlayerState(stack=1000, seat=0))
...
class TestHeroCallerBot(unittest.TestCase):
    ...
    def test_hero_caller_instantiation(self):
        ...
        hero = HeroCallerBot(id="hero1", name="Hero", state=PlayerState(stack=500, seat=0))
...
class TestManiacBot(unittest.TestCase):
    ...
    def test_maniac_raises_frequently(self):
        ...
        maniac = ManiacBot(id="man1", name="Maniac", state=PlayerState(stack=800, seat=0))
        maniac.state.holding = Holding(cards=[
        ...
        action = maniac.decide_action(game, [ActionType.RAISE, ActionType.BET, ActionType.CALL], min_raise=20)
...
class TestLoosePassiveBot(unittest.TestCase):
    ...
    def test_loose_passive_calls_often(self):
        ...
        lp = LoosePassiveBot(id="lp1", name="Station", state=PlayerState(stack=700, seat=0))
        lp.state.holding = Holding(cards=[
        ...
        action = lp.decide_action(game, [ActionType.CALL, ActionType.FOLD], min_raise=10)
        self.assertIsNotNone(action)
...
class TestFoldBot(unittest.TestCase):
    ...
    def test_foldbot_always_folds(self):
        ...
        action = fold.decide_action(game, [ActionType.FOLD, ActionType.CALL], min_raise=10)
        self.assertEqual(action.action_type, ActionType.FOLD)
    ...
    def test_foldbot_checks_when_no_fold(self):
        ...
        action = fold.decide_action(game, [ActionType.CHECK, ActionType.BET], min_raise=10)
        self.assertEqual(action.action_type, ActionType.CHECK)
...
class TestCallBot(unittest.TestCase):
    ...
    def test_callbot_always_calls(self):
        ...
        action = call.decide_action(game, [ActionType.CALL, ActionType.FOLD], min_raise=10)
        self.assertEqual(action.action_type, ActionType.CALL)
    ...
    def test_callbot_checks_when_no_call(self):
        ...
        action = call.decide_action(game, [ActionType.CHECK, ActionType.BET], min_raise=10)
        self.assertEqual(action.action_type, ActionType.CHECK)
...
class TestAggressiveBot(unittest.TestCase):
    ...
    def test_aggressivebot_prefers_aggressive_actions(self):
        ...
        aggressive = AggressiveBot(id="agg1", name="Aggressive", state=PlayerState(stack=500, seat=0))
        
        game = Mock()
        game.state.pot = 50
        game.state.big_blind = 10
        
        action = aggressive.decide_action(game, [ActionType.RAISE, ActionType.CALL], min_raise=20)
    ...
    def test_aggressivebot_bets_when_available(self):
        ...
        action = aggressive.decide_action(game, [ActionType.BET, ActionType.CHECK], min_raise=10)
