...
class TestPlayerUidDeprecations(unittest.TestCase):
    ...
    def test_player_init_id_param_deprecated(self):
        ...
        self.assertTrue(
            any(
                "Passing id= to Player.__init__ is deprecated" in str(w.message)
                for w in caught
            )
        )
...
class TestPlayerActionUidDeprecations(unittest.TestCase):
    ...
    def test_player_id_deprecated_constructor(self):
        ...
        self.assertTrue(
            any(
                "PlayerAction 'player_id' parameter is deprecated" in str(w.message)
                for w in caught
            )
        )
    ...
    def test_player_id_deprecated_property(self):
        ...
        self.assertTrue(
            any(
                "PlayerAction.player_id is deprecated" in str(w.message) for w in caught
            )
        )
...
class TestGameEventUidDeprecations(unittest.TestCase):
    ...
    def test_player_id_deprecated_constructor(self):
        ...
        self.assertTrue(
            any(
                "GameEvent 'player_id' parameter is deprecated" in str(w.message)
                for w in caught
            )
        )
    ...
    def test_id_deprecated_constructor(self):
        ...
        self.assertTrue(
            any(
                "GameEvent 'id' parameter is deprecated" in str(w.message)
                for w in caught
            )
        )
